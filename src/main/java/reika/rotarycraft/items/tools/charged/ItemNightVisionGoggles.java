...
public class ItemNightVisionGoggles extends ItemChargedArmor {
    ...
    public ItemNightVisionGoggles() {
        super(ArmorMaterials.IRON, ArmorType.HELMET, reika.rotarycraft.registry.RotaryItems.itemProperties());
    }
    ...
    public void onArmorTick(ItemStack stack, Level world, Player player) {
        if (stack.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag().getIntOr("power", 0) < 5) {
