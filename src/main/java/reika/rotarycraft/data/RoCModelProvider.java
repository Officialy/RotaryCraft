...
public class RoCModelProvider extends ModelProvider {
    ...
    protected void registerModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        for (var holder : RotaryBlocks.BLOCKS.getEntries()) {
            ...
            if (block instanceof BlockBlastFurnace) {
                ...
                var placeholder = new net.minecraft.client.resources.model.sprite.Material(pipePlaceholderTexture(block));
            ...
            if (asItem != Items.AIR) {
                ...
                if (mr != null && mr.hasModel() && mr.getModel() != null) {
                    itemModelOut.accept(asItem, ItemModelUtils.specialModel(
                            blockModelId,
                            new MachineItemRenderer.Unbaked(mr.name().toLowerCase(java.util.Locale.ROOT))
                    ));
                } else {
        ...
        java.util.stream.Stream.concat(
                ...
                reika.rotarycraft.Tests.ITEMS.getEntries().stream()
        ).forEach(holder -> {
    ...
    /**
     * Builds a {@link net.minecraft.client.resources.model.sprite.Material} pointing at
     ...
     */
    private static net.minecraft.client.resources.model.sprite.Material texture(String base) {
