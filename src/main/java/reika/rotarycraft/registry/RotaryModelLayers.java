...
public class RotaryModelLayers {
    ...
    public static final ModelLayerLocation FLOODLIGHT = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "lamp"), "main");
    public static final ModelLayerLocation FLOODLIGHT_VERTICAL = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "lamp_vertical"), "main");

    public static final ModelLayerLocation SHAFT = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "shaft"), "main");
    public static final ModelLayerLocation SHAFT_VERTICAL = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "shaft_vertical"), "main");
    public static final ModelLayerLocation SHAFT_CROSS = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "shaft_cross"), "main");
    public static final ModelLayerLocation BEVEL = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "bevel"), "main");
    public static final ModelLayerLocation SMOKE_DETECTOR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "smoke_detector"), "main");
    public static final ModelLayerLocation PLAYER_DETECTOR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "player_detector"), "main");
    public static final ModelLayerLocation VAN_DE_GRAFF = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "van_de_graff"), "main");
    public static final ModelLayerLocation HEAT_RAY = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "heat_ray"), "main");
    public static final ModelLayerLocation COOLING_FIN = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "cooling_fin"), "main");
    public static final ModelLayerLocation DYNOMONITOR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "dynomonitor"), "main");
    public static final ModelLayerLocation LANDMINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "landmine"), "main");
    public static final ModelLayerLocation DC_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "dc_engine"), "main");
    public static final ModelLayerLocation VACCUUM = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "vacuum"), "main");
    public static final ModelLayerLocation RESERVOIR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "reservoir"), "main");
    public static final ModelLayerLocation SPLITTER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "splitter"), "main");
    public static final ModelLayerLocation SPLITTER_2 = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "splitter_2"), "main");

    public static final ModelLayerLocation STEAM_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "steam_engine"), "main");
    public static final ModelLayerLocation COMBUSTION_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "combustion_engine"), "main");
    public static final ModelLayerLocation AC_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "ac_engine"), "main");
    public static final ModelLayerLocation PERFORMANCE_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "performance_engine"), "main");
    public static final ModelLayerLocation MICRO_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "micro_engine"), "main");
    public static final ModelLayerLocation JET_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "jet_engine"), "main");
    public static final ModelLayerLocation HYDRO_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "hydro_engine"), "main");
    public static final ModelLayerLocation WIND_ENGINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "wind_engine"), "main");
    public static final ModelLayerLocation MIRROR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "mirror"), "main");
    public static final ModelLayerLocation GEARBOX = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "gearbox"), "main");
    public static final ModelLayerLocation GEARBOX_4 = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "gearbox_4"), "main");
    public static final ModelLayerLocation GEARBOX_8 = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "gearbox_8"), "main");
    public static final ModelLayerLocation GEARBOX_16 = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "gearbox_16"), "main");
    public static final ModelLayerLocation GEARBOX_BASE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "gearbox_base"), "main");
    public static final ModelLayerLocation MAGNETIC = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "magnetic"), "main");
    public static final ModelLayerLocation SOLAR_TOWER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "solar_tower"), "main");
    public static final ModelLayerLocation BIG_FURNACE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "big_furnace"), "main");
    public static final ModelLayerLocation WORM = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "worm_model"), "main");
    public static final ModelLayerLocation CVT = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "cvt_model"), "main");
    public static final ModelLayerLocation COIL = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "coil_model"), "main");
    public static final ModelLayerLocation HIGHGEAR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "high_gear_model"), "main");
    public static final ModelLayerLocation GRINDER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "grinder"), "main");
    public static final ModelLayerLocation FLYWHEEL = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "flywheel"), "main");
    public static final ModelLayerLocation STEAM_TURBINE = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "steam_turbine"), "main");
    public static final ModelLayerLocation SPILLWAY = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "spillway"), "main");
    public static final ModelLayerLocation DISTRIB_CLUTCH = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "distrib_clutch"), "main");
    public static final ModelLayerLocation BOILER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "boiler"), "main");
    public static final ModelLayerLocation BEAM_MIRROR = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "beam_mirror"), "main");
    public static final ModelLayerLocation MULTI_CLUTCH = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "multi_clutch"), "main");
    public static final ModelLayerLocation WINDER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "winder"), "main");
    public static final ModelLayerLocation HEATER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "heater"), "main");
    public static final ModelLayerLocation PUMP = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "pump"), "main");
    public static final ModelLayerLocation AEROSOLIZER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(RotaryCraft.MODID, "aerosolizer"), "main");
