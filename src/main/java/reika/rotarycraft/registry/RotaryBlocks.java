...
public class RotaryBlocks {
    ...
    public static final DeferredBlock<Block> FILLING_STATION = registerMachineBlock("filling_station", () -> new BlockFillingStation(blockProperties().strength(20)));
    ...
    public static final DeferredBlock<Block> BEDROCK_BREAKER = registerMachineBlock("bedrock_breaker", () -> new BlockBedrockBreaker(blockProperties().strength(20)));
    ...
    public static final DeferredBlock<Block> BORER = registerMachineBlock("borer", () -> new BlockBorer(blockProperties().strength(5)));
    ...
    public static final DeferredBlock<Block> LAVAMAKER = registerMachineBlock("rock_melter", () -> new BlockLavaMaker(blockProperties().strength(5)));
    ...
    public static final DeferredBlock<Block> AUTOBREEDER = registerMachineBlock("auto_breeder", () -> new BlockAutoBreeder(blockProperties().strength(5)));
    public static final DeferredBlock<Block> SPLITBELT = registerMachineBlock("split_belt", () -> new BlockSplitBelt(blockProperties().strength(5)));
    ...
    public static final DeferredBlock<Block> GASTANK = registerMachineBlock("gas_tank", () -> new reika.rotarycraft.base.blocks.entity.BlockGasTank(blockProperties().strength(5)));
