...
public class RecipesPulseFurnace extends RecipeHandler implements PulseFurnaceManager {
	...
	private RecipesPulseFurnace() {
		...
		this.addSmelting(Items.iron_ingot, ReikaItemHelper.getSizedItemStack(RotaryItems.steelingot, 2), 900, RecipeLevel.CORE);

		this.addRecycling();

		this.addSmelting(RotaryItems.redgolddust, RotaryItems.redgoldingot, RecipeLevel.CORE);
	...
	private ItemStack getSizedSteel(int size) {
		return ReikaItemHelper.getSizedItemStack(RotaryItems.steelingot, size);
	}
