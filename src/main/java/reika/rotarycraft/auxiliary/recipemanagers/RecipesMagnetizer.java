...
//
//		this.addRecipe(RotaryItems.HSLA_SHAFT_CORE.get().getDefaultInstance(), 0, 2, 2, false, RecipeLevel.CORE);
//		this.addRecipe(RotaryItems.TUNGSTEN_ALLOY_SHAFT_CORE.get().getDefaultInstance(), 0, 2, 1, false, RecipeLevel.CORE);
//		this.addRecipe(RotaryItems.UPGRADE.get().getDefaultInstance().getTag().putInt("upgradeType", ItemEngineUpgrade.UpgradeType.MAGNETOSTATIC2.ordinal()), 32768, 1, 4, true, RecipeLevel.CORE);
//	}
//
