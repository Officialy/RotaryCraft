...
//
//		this.addRecipe(RotaryItems.TUNGSTEN_FLAKES.get().getDefaultInstance(), RotaryItems.TUNGSTEN_INGOT.get().getDefaultInstance(), 1350, 600, RecipeLevel.CORE);
//		this.addRecipe(RotaryItems.SILICON_DUST.get().getDefaultInstance(), RotaryItems.SILICON.get().getDefaultInstance(), 800, 200, RecipeLevel.PROTECTED);
//	}
//
