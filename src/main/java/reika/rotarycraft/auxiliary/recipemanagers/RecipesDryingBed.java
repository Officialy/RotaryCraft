...
//
//		this.addRecipe(Fluids.WATER, 250, RotaryItems.SALT, RecipeLevel.CORE);
//		this.addRecipe(Fluids.LAVA, 1000, new ItemStack(Items.GOLD_NUGGET), RecipeLevel.PERIPHERAL);
...
//			return input.getFluid().toString()+":"+input.amount+">"+fullID(output);
//		} //todo get name not toString
//
//		@Override
...
//		if (cr == null)
//			return null;
//		int req = cr.input.getAmount();
//		if (req > liquid.getAmount())
//			return null;
...
//		return cr != null ? cr.input.getAmount() : 0;
//	}
//
