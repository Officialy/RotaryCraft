...
public class RecipesCompactor extends RecipeHandler implements CompactorManager
{
	...
	private RecipesCompactor() {
		...
		this.addRecipe(RotaryItems.anthracite, ItemRegistry.COMPACTS.getCraftedMetadataProduct(this.getNumberPerStep(), 1), rp, rt, RecipeLevel.CORE);
		this.addRecipe(RotaryItems.prismane, ItemRegistry.COMPACTS.getCraftedMetadataProduct(this.getNumberPerStep(), 2), rp, rt, RecipeLevel.CORE);
