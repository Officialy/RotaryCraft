...
public class RecipesGrinder extends RecipeHandler implements GrinderManager {
	...
	private RecipesGrinder() {
		...
		this.addRecipe(Blocks.netherrack, RotaryItems.netherrackdust, RecipeLevel.CORE);
		this.addRecipe(Blocks.soul_sand, RotaryItems.tar, RecipeLevel.CORE);

		this.addRecipe(Items.wheat, ReikaItemHelper.getSizedItemStack(RotaryItems.flour, 3), RecipeLevel.PERIPHERAL);

		this.addRecipe(RotaryItems.bedingot.copy(), ReikaItemHelper.getSizedItemStack(RotaryItems.bedrockdust, 4), RecipeLevel.PROTECTED);
		this.addRecipe(RotaryItems.aluminumingot.copy(), RotaryItems.aluminumpowder.copy(), RecipeLevel.PROTECTED);

		this.addRecipe(Items.reeds, new ItemStack(Items.sugar, 3), RecipeLevel.PROTECTED);//, ReikaItemHelper.getSizedItemStack(RotaryItems.mulch, PlantMaterials.SUGARCANE.getPlantValue()));
		...
		this.addRecipe(Items.coal, RotaryItems.coaldust, RecipeLevel.CORE);

		this.addRecipe(RotaryItems.canolaSeeds, RotaryItems.canolaHusks, RecipeLevel.CORE);
	...
	private ItemStack getSizedSawdust(int size) {
		return ReikaItemHelper.getSizedItemStack(RotaryItems.sawdust, size);
	}
	...
	public void addPostLoadRecipes() {
		...
		this.addOreDictRecipe("netherrack", RotaryItems.netherrackdust, RecipeLevel.CORE);
		this.addOreDictRecipe("soulsand", RotaryItems.tar, RecipeLevel.CORE);
