...
//		Minecraft.getMinecraft().fontRenderer.text(String.format("Required Pressure: %d kPa", pressure), 0, 85, 0xFF333333, false);
//		Minecraft.getMinecraft().fontRenderer.text(String.format("Required Temperature: %dC", temperature), 0, 95, 0xFF333333, false);
//	}
//
