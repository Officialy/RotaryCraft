...
//import reika.rotarycraft.gui.achine.Inventory.GuiBlastFurnace;
//
...
//			if (ReikaItemHelper.matchStacks(recipe.outputItem(), RotaryItems.steelblock)) {
//				return null;
//			}
...
//			if (ReikaItemHelper.matchStacks(recipe.outputItem(), RotaryItems.steelblock)) {
//				li.add(new PositionedStack(ReikaItemHelper.getSizedItemStack(RotaryItems.HSLA_STEEL_INGOT, 2), 143, 24));
...
//				else
//					RotaryCraft.LOGGER.error("Unrenderable recipe, makes "+p.outputItem()+"!");
//			}
//		}
