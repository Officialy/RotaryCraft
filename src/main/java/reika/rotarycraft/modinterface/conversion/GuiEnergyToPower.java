...
//		}
//
//		this.centeredText(font, String.format("Torque: %d Nm", torque), SHIFT+getXSize()/2-dx, getYSize()-30-48+6, 0xFFFFFFFF);
//
//		this.centeredText(font, String.format("Speed: %d rad/s", omega), SHIFT+getXSize()/2-dx, getYSize()-30-48+6+dy, 0xFFFFFFFF);
//		this.centeredText(font, String.format("Power: %.3f %sW", ReikaMathLibrary.getThousandBase(power), ReikaEngLibrary.getSIPrefix(power)), SHIFT+getXSize()/2-dx, getYSize()-30-48+6+dy*2, 0xFFFFFFFF);
//
