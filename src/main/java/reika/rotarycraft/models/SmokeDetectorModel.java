...
public class SmokeDetectorModel extends RotaryModelBase {

    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/blockentitytex/smokedetectortex.png");

    private final ModelPart shape1;
    private final ModelPart shape2;
    // 1.21.5: Model already declares a protected `root`; removed shadowing field.

    public SmokeDetectorModel(ModelPart modelPart) {
