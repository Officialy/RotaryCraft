...
public class BedrockBreakerModel extends RotaryModelBase {
    ...
    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/blockentitytex/bedrocktex.png");
    ...
    public BedrockBreakerModel(ModelPart modelPart) {
    ...
    public static LayerDefinition createLayer() {
        ...
        root.addOrReplaceChild("shape6",
                CubeListBuilder.create()
                        ...
                        .texOffs(96, 0)
                        .addBox(0, 0, 0, 3, 3, 1),
                PartPose.offsetAndRotation(-2.5F, 8.5F, -2.5F, 0, 0, 0));
        ...
        root.addOrReplaceChild("shape6a",
                CubeListBuilder.create()
                        ...
                        .texOffs(104, 0)
                        .addBox(0, 0, 0, 1, 3, 4),
                PartPose.offsetAndRotation(0.5F, 8.5F, -2, 0, 0, 0));
        ...
        root.addOrReplaceChild("shape6b",
                CubeListBuilder.create()
                        ...
                        .texOffs(104, 0)
                        .addBox(0, 0, 0, 1, 3, 4),
                PartPose.offsetAndRotation(-3.5F, 8.5F, -2, 0, 0, 0));
        ...
        root.addOrReplaceChild("shape6c",
                CubeListBuilder.create()
                        ...
                        .texOffs(96, 0)
                        .addBox(0, 0, 0, 3, 3, 1),
                PartPose.offsetAndRotation(-2.5F, 8.5F, 1.5F, 0, 0, 0));
