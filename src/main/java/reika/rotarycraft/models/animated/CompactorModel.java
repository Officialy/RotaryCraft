...
public class CompactorModel extends RotaryModelBase {
    ...
    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/blockentitytex/compactortex.png");
