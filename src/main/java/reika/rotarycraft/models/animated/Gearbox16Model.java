...
public class Gearbox16Model extends GearboxBaseModel {
    ...
    /**
     * Faithful to {@code ModelGearbox16.renderAll}: six geared stages (1.1x, 1.25x x3, then 2x)
     * driving the shaft-speed output gear. Every translate here is undone, so the supports sit at
     * the origin.
     */
    @Override
