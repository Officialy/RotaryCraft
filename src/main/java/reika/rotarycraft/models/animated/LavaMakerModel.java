...
public class LavaMakerModel extends RotaryModelBase {

    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/blockentitytex/lavamakertex.png");
    ...
    public void renderAll(PoseStack stack, VertexConsumer tex, int light, BlockEntity te,
        ...
        if ((Boolean)conditions.get(0)) {
            ...
            shape5j.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5k.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5l.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5m.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5n.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5o.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5p.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
            shape5q.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
        }
    }
