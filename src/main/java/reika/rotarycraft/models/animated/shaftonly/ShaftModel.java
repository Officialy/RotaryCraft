...
public class ShaftModel extends RotaryModelBase {
    ...
    public Identifier getTexture() {
        // {@link #TEXTURE_LOCATION} is a directory prefix that the world-renderer concatenates
        // with the per-material suffix at draw time. For item rendering (MachineItemRenderer
        // resolves the texture via this getter) we need a concrete .png — default to the base
        // steel shaft texture so the item shows a sensible icon.
