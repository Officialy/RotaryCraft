...
public class MirrorModel extends RotaryModelBase {

    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/blockentitytex/mirrortex.png");
    ...
    public void renderAll(PoseStack stack, VertexConsumer tex, int light, BlockEntity te,
        ...
        boolean broken = (Boolean)conditions.get(0);
        ...
        shape3as.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);

        double sc = 1-0.725*Math.cos(Math.toRadians(theta))*Math.sin(Math.toRadians(-theta));
        double d = 1.5;
        stack.translate(0, d, 0);
        stack.scale(1, (float) sc, 1);
        stack.translate(0, -d, 0);
        shape5a.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
        shape5af.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
        shape5as.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
        stack.translate(0, d, 0);
        stack.scale(1, (float) (1D / sc), 1);
        stack.translate(0, -d, 0);
