...
public class CentrifugeModel extends RotaryModelBase {

    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(MODID, "textures/blockentitytex/centrifugetex.png");
    ...
    public void renderAll(PoseStack stack, VertexConsumer tex, int light, BlockEntity te,
        ...
        shape3c2.render(stack, tex, light, OverlayTexture.NO_OVERLAY, 0xFFFFFFFF);
