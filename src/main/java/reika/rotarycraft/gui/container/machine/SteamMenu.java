...
public class SteamMenu extends IOMachineMenu<BlockEntitySteamEngine> {

    public final BlockEntitySteamEngine steam;

    //Client
    public SteamMenu(int id, Inventory inv, FriendlyByteBuf data) {
        this(id, inv, (BlockEntitySteamEngine) inv.player.level.getBlockEntity(data.readBlockPos()));
    }

    public SteamMenu(int id, Inventory inv, BlockEntitySteamEngine te) {
